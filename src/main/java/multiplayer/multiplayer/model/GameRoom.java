...
public class GameRoom {
    ...
    // kommer att sparas här, där nyckeln är position som PositionDTO som består av x och y,
    // och värdet är en String som är ett playerId. (kan exempelvis användas för att visa *vem* man kolliderat med)
